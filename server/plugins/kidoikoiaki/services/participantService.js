        ...
        sendMail: function(participantData)
        {
            ...
            sheetService.getSheetById(participantData.prt_sheet).then(function(sheet)
            {
                ...
                var mailOptions =
                {
                    ...
                    "Vous pouvez la consulter et la partager à n'importer quel moment à l'adresse suivante : <a href='" + participantData.she_path + '/#/sheet/' + participantData.she_reference_private + '/' + "'>" + sheet.she_reference_private + "</a>.<br><br>" +
                ...
                transporter.sendMail(mailOptions, function(error, info)
                {
                    if(error)
                    {
                        ...
                        console.log("Message automatique d'ajout d'un participant à la feuille " + sheet.she_reference_private + " non envoyé.");
                    }
                    else
                    {
                        deferred.resolve(info);
                        console.log("Message automatique d'ajout d'un participant à la feuille " + sheet.she_reference_private + " envoyé avec succès.");
                    }
                });
            })
            .catch(function(err)
